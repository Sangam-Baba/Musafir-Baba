    ...
    <section className="w-full px-4 md:px-8 lg:px-20 py-16">
      <div className="flex flex-col gap-2 items-center max-w-7xl mx-auto">
        ...
        <div className="flex  justify-between  items-center w-full p-2">
          ...
          <div>
              <Link href={`https://musafirbaba.com/${active==="domestic"?"india":"india"}`} className="text-[#FE5300] font-semibold" > View All</Link>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 mt-10 w-full">
            <div className="flex flex-col md:flex-row gap-4 md:w-1/2">
              ...
              <div className="md:w-1/2">
                <div className="relative">
                 ...
                 <Image src="https://res.cloudinary.com/dmmsemrty/image/upload/v1758340822/Untitled_design_5_hgguwf.jpg" alt="Kerala" className="rounded-2xl w-full md:h-118 h-56 object-cover"  width={500} height={500}/>
                  </Link>
                 <div className="absolute bottom-2 left-0 right-0 bg-black/50 text-white text-center py-1 font-semibold">
                   Kerala
                 </div>
            ...
            <div className="flex flex-col gap-4 md:w-1/2">
             ...
             <div className="flex flex-col md:flex-row gap-4 w-full">
                ...
                <Link href="/india/himachal%20pradesh">
                 ...
                 <div className="relative md:w-1/2">
                 <Link href="/india/jammu%20&%20kashmir">
        ...
        {active === "international" && (
          <div className="flex flex-col md:flex-row gap-4 mt-10 w-full">
            <div className="flex flex-col md:flex-row gap-4 md:w-1/2">
              ...
              <div className="md:w-1/2">
                <div className="relative">
                 <Image src="https://res.cloudinary.com/dmmsemrty/image/upload/v1758107531/Bali_sc5oct.jpg" alt="Bali" className="rounded-2xl w-full md:h-118 h-56 object-center" width={500} height={500}/>
                 <div className="absolute bottom-2 left-0 right-0 bg-black/50 text-white text-center py-1 font-semibold">
                   Bali
                 </div>
                </div>
