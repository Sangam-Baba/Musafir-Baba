...
// Homepage-only variant of PackageCard.tsx, used exclusively by
// FeaturedTour.tsx. PackageCard itself is shared across 7+ other places
// (holidays listing, category/detail pages, travel-agency) and is
// deliberately left untouched — this file exists so the homepage carousel
// can look different without changing any of those other pages.
//
// Difference from PackageCard: the price no longer overlays the image as a
// badge; it now lives in the gray meta pill that used to show "Location"
// (destination is still shown via the small orange tag line above the
// title, so no information is lost — just moved).
