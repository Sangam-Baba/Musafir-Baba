...
const testi = [
  {
    ...
    name: "Poonom Ranjan",
    title: "Traveler",
    content: `Musafirbaba provided excellent service in a highly professional manner. They went above and beyond to assist me, and I want to give a special shoutout to Anu, my tour manager. Anu guided me through the entire tour planning process, helped with various activities, and ensured everything was seamless until I landed in Delhi. I wholeheartedly recommend Musafirbaba to everyone.`,
  },
  {
    id: 2,
    name: "Anupam Ray",
  ...
  },
  {
    ...
    title: "Traveler",
    content:
      "Booking with Musafir Baba was the best decision for our family trip. Everything was perfectly organized — from comfortable stays to local guides who truly knew the hidden gems. Highly recommend them to anyone who wants stress-free and memorable vacations!",
  },
  {
    id: 4,
    name: "Shubham Sharma",
  ...
  return (
    <section className="w-full px-4 md:px-8 lg:px-20 py-16 flex flex-col items-center">
      ...
      <div className="flex flex-col gap-2 items-center py-4 text-center">
        <h1 className="text-3xl md:text-4xl font-bold">Why Choose Musafirbaba?</h1>
          ...
          {testi.map((item) => (
            ...
            >
              <div className="p-8 w-full">
                <Card className="rounded-2xl bg-[#ffe2a2] shadow-lg hover:shadow-2xl shadow-[#cdffc9]/100 h-full flex flex-col justify-between">
