        ...
        <Table className="rounded-2xl shadow-md overflow-hidden">
          <TableHeader>
            <TableRow className="bg-muted/40">
              ...
              <TableHead className="w-[20%]">Valid Expiry</TableHead>
          ...
          <TableBody>
            {allCoupans.map((cat: CoupansInterface) => (
              ...
              >
                ...
                <TableCell className="font-medium">{cat.validTill}</TableCell>
        ...
        {allCoupans.map((cat: CoupansInterface) => (
          <Card key={cat._id} className="shadow-md">
            <CardContent className="p-4 space-y-2">
              ...
              <h3 className="font-semibold text-lg">{cat.type}</h3>
              <h3 className="font-semibold text-lg">{cat.value}</h3>
              <h3 className="font-semibold text-lg">{cat.validTill}</h3>
