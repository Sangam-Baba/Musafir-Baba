...
export default function UpdateWebpage() {
  ...
  }, [webpage, form, token, allparents, isReset]);
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 min-h-screen bg-slate-50/10">
      <div className="bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden">
        <div className="p-5 md:p-6 space-y-6">
          <div className="space-y-0.5 text-center">
            <h1 className="text-lg font-black text-slate-800 tracking-tight">Edit Webpage</h1>
            <p className="text-[9px] text-slate-400 font-bold uppercase tracking-[0.2em]">Updating Existing Content</p>
          </div>
          ...
          >
            ...
            <div className="flex items-center justify-end gap-3 pt-6 border-t border-slate-100">
              ...
              >
                {mutation.isPending ? "Syncing..." : "Update Webpage"}
              </Button>
            </div>
          </form>
        </div>
      ...
      {showReviewsModal && (
        <div className="fixed inset-0 bg-slate-900/40 flex items-center justify-center z-50 backdrop-blur-sm transition-all">
