...
// ✅ API helpers
const createCustomizedPackage = async (data: FormData, accessToken: string) => {
  ...
  if (!res.ok) {
    ...
    throw new Error(err.message || "Failed to create customized package");
  }
...
export default function Page() {
  ...
  const mutation = useMutation({
    mutationFn: (values: FormData) =>
      createCustomizedPackage(values, accessToken as string),
    onSuccess: () => {
      toast.success("Customized package created successfully!");
    },
    onError: (err) => {
