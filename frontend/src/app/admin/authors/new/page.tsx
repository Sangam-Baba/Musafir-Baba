...
export default function RegisterAuthor() {
  ...
  const mutation = useMutation({
    mutationFn: (values: AuthorFormValues) => registerAuthor(values, accessToken),
    onSuccess: (data) => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-md">
        <h1 className="mb-6 text-center text-2xl font-bold">Create an Author</h1>
        ...
        {mutation.isSuccess && (
          <p className="mt-3 text-center text-sm text-green-600">Registration successful!</p>
        )}
      </div>
    </div>
  )
