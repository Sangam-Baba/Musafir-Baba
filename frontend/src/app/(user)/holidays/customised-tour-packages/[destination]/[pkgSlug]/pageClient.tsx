                      ...
                      return (
                        <>
                          ...
                          <div className="flex flex-col gap-2 text-gray-600 text-sm md:text-base flex-1">
                            ...
                            <p><span className="font-semibold text-gray-800">Last Updated:</span> {pkg.updatedAt ? new Date(pkg.updatedAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : "Regularly Updated Before Every Season"}</p>
                          </div>
                        </>
                      );
                    })()}
