...
try {
    ...
    const emailResponse=await sendEmail("care@musafirbaba.com", subject , emailBody)
...
const getAllContact = async ( req, res)=>{
    try {
        ...
        res.status(200).json({success:true, message:"Contact fetched successfully", data:contacts});
    } catch (error) {
