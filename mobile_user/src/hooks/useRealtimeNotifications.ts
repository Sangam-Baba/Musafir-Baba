...
import { getNotificationsRealtimeToken } from '../api/riderNotification.api';
 ...
 * the rider is authenticated, and feeds incoming notification events into
 * useNotificationStore so the notifications screen and any unread badges
 * update instantly instead of waiting for the next screen load. Purely
 * additive -- doesn't touch the existing push-notification flow
