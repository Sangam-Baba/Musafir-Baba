...
const UserPlusIcon = ({ color = "#FF5500", size = 26 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const PhoneIcon = ({ color = "currentColor", size = 18 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const ChevronDownIcon = ({ color = "currentColor", size = 14 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export default function App() {
  ...
  const handleOtpChange = (value: string, index: number) => {
    ...
    if (value && index < 5) {
      (otpRefs[index + 1].current as HTMLInputElement | null)?.focus();
    }
  };
