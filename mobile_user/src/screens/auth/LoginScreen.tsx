...
export default function LoginScreen() {
  ...
  const activeScreen: string = 'login';
              ...
              {activeScreen === 'login' && (
                <View className="space-y-4 animate-in fade-in duration-200">
                  ...
                  <View className="flex items-center justify-between pt-1 flex-row">
                    ...
                    >
                      <View className={`w-4 h-4 rounded border flex items-center justify-center ${rememberMe ? 'bg-[#FF4500] border-[#FF4500]' : 'border-slate-300 bg-white'}`}>
...
console.log('CACHE_BUST_FINAL_BARS_1786125430899');

console.log('CACHE_BUST_HTML_TO_RN_1786128166223');

console.log('CACHE_BUST_AST_FIX_1786128723219');
