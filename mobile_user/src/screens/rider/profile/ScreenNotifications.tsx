...
export default function ScreenNotifications({ onNavigate }: { onNavigate: (screen: string) => void }) {
          ...
          {activeScreen === '38' && (
            <View className="p-4 space-y-3.5 animate-in fade-in duration-200 bg-[#FAFAFA] pb-24">
              ...
              <View className="flex items-center justify-between py-1 flex-row">
                <TouchableOpacity onPress={() => onNavigate('36')} className="p-1.5 hover:bg-slate-100 rounded-full">
...
// FORCE_REBUILD_CACHE_BUST_1786123613907
console.log('CACHE_BUST_1786124057440');

console.log('CACHE_BUST_BARS_1786124237193');

console.log('CACHE_BUST_PROFILE_36_1786124896538');

console.log('CACHE_BUST_PROFILE_NAVBAR_1786125091859');

console.log('CACHE_BUST_STANDARDIZE_NAVBAR_1786125270482');

console.log('CACHE_BUST_FINAL_BARS_1786125430920');

console.log('CACHE_BUST_LOGOUT_1786125695815');

console.log('CACHE_BUST_IMG_TO_IMAGE_1786127909118');

console.log('CACHE_BUST_HTML_TO_RN_1786128166256');

console.log('CACHE_BUST_AST_FIX_1786128723901');
